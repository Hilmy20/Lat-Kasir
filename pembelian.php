<div class="container-fluid px-4">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="?page=pembelian_detail&&id=<?= $data['id_penjualan']; ?>" class="btn btn-secondary">Detail</a>
                <a href="?page=penjualan_hapus&&id=<?= $data['id_penjualan']; ?>" class="btn btn-danger">Hapus</a>
            </td>
        </tr>
        <?php
        }
