...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2025 at 11:10 AM
...
(1, 'Doyok', 'Jakarta', '089166678812'),
(3, 'Saddam', 'Jati Kramat', '082272635421'),
(4, 'Jepa', 'Kalibata', '0882643219234');
...
(2, '2025-01-26', 465000, 3),
(3, '2025-01-26', 480000, 4);
...
(1, 'Mie Rendang', 15000, 30),
(3, 'Nasi goreng', 10000, 20),
(4, 'Burger', 20000, 20),
(5, 'Pizza', 70000, 10);
...
(3, 'Baya Gendut', 'baya', '93ceba387097e955b1fa2a90e490fecd', 'admin');
